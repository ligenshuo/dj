...
| **MLR-Copilot: Autonomous Machine Learning Research based on Large Language Models Agents** | arXiv, 2024 | TBD | 利用LLM实现自动机器学习研究的协同Agent系统，模拟研究者行为，实现从选题到实验自动化 | - LLM Agents<br>- AutoML<br>- Research Automation | - 多Agent协作（如 Researcher、Coder、Reviewer）<br>- 自动论文选题与实验设计<br>- 支持外部工具调用 | 构建虚拟AI研究助手，自动执行选题、文献调研、模型训练与结果分析等任务，推动AI辅助科研 |
| **MLGym: A New Framework and Benchmark for Advancing AI Research Agents** | arXiv, 2025 | TBD | 为AI科研代理构建训练和评估环境，标准化研究任务并提供基准测试 | - Benchmark & Framework<br>- LLM Research Agents<br>- Evaluation Tools | - 提供科研Agent的标准任务环境<br>- 多维度评估标准（准确性、创新性、复现性）<br>- 支持插件与Agent模块集成 | 类似OpenAI Gym但面向科研任务，成为科研代理的标准化评估平台，推动Agent系统在科研中的实用化 |
